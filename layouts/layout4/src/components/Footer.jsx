...
export const Footer = () => {
  return (
    <footer className="bg-[#90D4C6] px-10 py-16">
      <img className="mx-auto mb-10" src={logoGreen} alt="logo green" />
      <div className="text-Dark-moderate-cyan mx-auto mb-[88px] flex w-[297px] place-content-between font-Barlow text-lg">
      ...
      <div className="mx-auto flex w-[164px] place-content-between">
        <svg
          className="cursor-pointer fill-[#2C7566] hover:fill-white"
          width="20"
          height="20"
