...
export const TestimonialContainer = () => {
  return (
    <section className="bg-white px-6 pt-16 desktop:pt-40">
      <h2 className="mb-16 text-center font-Fraunces uppercase text-Grayish-blue xl:text-xl desktop:mb-20">
        Client testimonials
      </h2>
      <div className="lg:mx-auto lg:flex lg:w-[900px] xl:w-[1110px]">
        <Testimonial
          img={emilyImg}
